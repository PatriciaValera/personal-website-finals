...
.logo {
  ...
  text-shadow: 
    3px 3px 0 var(--kuromi-dark-purple),
    -1px -1px 0 var(--kuromi-purple);
  letter-spacing: 2px;
...
@keyframes glow {
  0%, 100% { text-shadow: 3px 3px 0 var(--kuromi-dark-purple), -1px -1px 0 var(--kuromi-purple); }
  50% { text-shadow: 5px 5px 0 var(--kuromi-dark-purple), -2px -2px 0 var(--kuromi-pink); }
}
...
.lang-btn.active {
  ...
  text-shadow: 0 0 5px var(--kuromi-pink);
}
...
.banner-text {
  ...
  margin: 0 30px;
  letter-spacing: 2px;
  text-shadow: 1px 1px 0 var(--kuromi-white);
}
